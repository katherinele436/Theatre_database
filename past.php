...
$sql = "SELECT * FROM reservation join theatrecomplex on reservation.complexNumber = theatrecomplex.complexNumber where accountNum = " .$AccountNumber ." AND startingTime < '" .$date ."'";
